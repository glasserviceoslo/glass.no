...
export function Smijern({ children }: { children?: React.ReactNode }) {
  const features = [
    {
  ...
  //         </FeatureCard>
  //       ))}
  //       {/* Add a new grid item for the MDX content */}
  //       <FeatureCard className="col-span-1 lg:col-span-6">{children}</FeatureCard>
  //     </div>
  //   </div>
  // </div>
}
    ...
    <div className="relative flex py-8 px-2 gap-10 h-full">
      <div className="w-full  p-5  mx-auto bg-white dark:bg-neutral-900 shadow-2xl group h-full">
        <div className="flex flex-1 w-full h-full flex-col space-y-2  ">
          ...
          /> */}
          <div className="h-full w-full aspect-square bg-neutral-100 dark:bg-neutral-800 rounded-sm" />
        </div>
      </div>
    ...
    >
      <div className="w-full  mx-auto bg-transparent dark:bg-transparent group h-full">
        <div className="flex flex-1 w-full h-full flex-col space-y-2  relative">
          {/* TODO */}
          <PlaySquare className="h-20 w-20 absolute z-10 inset-0 text-red-500 m-auto " />
          {/* <Image
...
export const SkeletonFour = () => {
  return (
    <div className="h-60 md:h-60  flex flex-col items-center relative bg-transparent dark:bg-transparent mt-10">
      <div className="absolute -right-10 md:-right-10 -bottom-80 md:-bottom-72" />
    </div>
  );
};
